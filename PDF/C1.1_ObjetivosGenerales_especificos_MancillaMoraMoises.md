...
## Objetivo
Crear una plataforma web eficaz donde permita a todos los usuarios de la empresa almacenar y acceder toda la informacion de la empresa. Que la plataforma sea capaz de albergar usuarios que pueda publicar topicos con textos o con archivos multimedia y los propios usuarios puedan comentar y evaluar esos topicos.
## Objetivos Especificos



* Asegurrnos que la plataforma este disponible para los usarios de la empresa y todos tengan la habilidad de aportar topicos.
* Utilizar las evaluaciones para determinar los topicos mas utiles.
* Hacer que la plataforma sea util para que todos los usuarios la utilizen.

## Modelos del Negocio 
![](https://github.com/MoisesMM99/Analisis-Avanzado-de-Software-Mancilla-Mora/blob/main/img/Modelo%20de%20negocio.jpg?raw=true)
